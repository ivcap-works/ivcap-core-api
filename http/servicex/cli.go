...
func BuildCreateServicePayload(servicexCreateServiceBody string, servicexCreateServiceJWT string) (*servicex.CreateServicePayload, error) {
	...
	var body CreateServiceRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"banner\": \"http://kohler.info/johnpaul.spencer\",\n      \"description\": \"This service ...\",\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy\": \"urn:ivcap:policy:123e4567-e89b-12d3-a456-426614174000\",\n      \"references\": [\n         {\n            \"title\": \"Molestias ut at eligendi perspiciatis fugiat.\",\n            \"uri\": \"http://gislasonschneider.info/morgan.cronin\"\n         },\n         {\n            \"title\": \"Molestias ut at eligendi perspiciatis fugiat.\",\n            \"uri\": \"http://gislasonschneider.info/morgan.cronin\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Qui aut quod est maiores recusandae.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"gpu-number\": 2,\n            \"gpu-type\": \"nvidia-tesla-t4\",\n            \"image\": \"alpine\",\n            \"image-pull-policy\": \"Corrupti placeat iusto illo voluptate.\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            },\n            \"shared-memory\": \"1Gi\"\n         },\n         \"type\": \"basic\"\n      }\n   }'")
		}
...
func BuildUpdatePayload(servicexUpdateBody string, servicexUpdateID string, servicexUpdateForceCreate string, servicexUpdateJWT string) (*servicex.UpdatePayload, error) {
	...
	var body UpdateRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"banner\": \"http://brownmann.net/richard.gottlieb\",\n      \"description\": \"This service ...\",\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy\": \"urn:ivcap:policy:123e4567-e89b-12d3-a456-426614174000\",\n      \"references\": [\n         {\n            \"title\": \"Molestias ut at eligendi perspiciatis fugiat.\",\n            \"uri\": \"http://gislasonschneider.info/morgan.cronin\"\n         },\n         {\n            \"title\": \"Molestias ut at eligendi perspiciatis fugiat.\",\n            \"uri\": \"http://gislasonschneider.info/morgan.cronin\"\n         },\n         {\n            \"title\": \"Molestias ut at eligendi perspiciatis fugiat.\",\n            \"uri\": \"http://gislasonschneider.info/morgan.cronin\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Qui aut quod est maiores recusandae.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"gpu-number\": 2,\n            \"gpu-type\": \"nvidia-tesla-t4\",\n            \"image\": \"alpine\",\n            \"image-pull-policy\": \"Corrupti placeat iusto illo voluptate.\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            },\n            \"shared-memory\": \"1Gi\"\n         },\n         \"type\": \"basic\"\n      }\n   }'")
		}
		if body.Workflow == nil {
			err = goa.MergeErrors(err, goa.MissingFieldError("workflow", "body"))
		}
