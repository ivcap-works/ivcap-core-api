...
// CLI flags.
func BuildUploadPayload(artifactUploadJWT string, artifactUploadContentType string, artifactUploadContentEncoding string, artifactUploadContentLength string, artifactUploadName string, artifactUploadCollection string, artifactUploadMetadata string, artifactUploadXContentType string, artifactUploadUploadLength string, artifactUploadTusResumable string) (*artifact.UploadPayload, error) {
	var err error
	var jwt string
	{
...
// BuildRemoveMetadataPayload builds the payload for the artifact
// removeMetadata endpoint from CLI flags.
func BuildRemoveMetadataPayload(artifactRemoveMetadataID string, artifactRemoveMetadataSchema string, artifactRemoveMetadataJWT string) (*artifact.RemoveMetadataPayload, error) {
	var id string
	{
		id = artifactRemoveMetadataID
	}
	var schema string
	{
		schema = artifactRemoveMetadataSchema
	}
	var jwt string
	{
		jwt = artifactRemoveMetadataJWT
	}
	v := &artifact.RemoveMetadataPayload{}
	v.ID = id
	v.Schema = schema
	v.JWT = jwt
