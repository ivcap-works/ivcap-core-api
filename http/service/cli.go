...
func BuildCreateServicePayload(serviceCreateServiceBody string, serviceCreateServiceJWT string) (*service.CreateServicePayload, error) {
	...
	var body CreateServiceRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"account-id\": \"urn:ivcap:account:0f0e3f57-80f7-4899-9b69-459af2efd789\",\n      \"banner\": \"http://kovacekwitting.name/eusebio_kemmer\",\n      \"description\": \"This service ...\",\n      \"metadata\": [\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         },\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         },\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         }\n      ],\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy-id\": \"Sit expedita enim et ullam quis.\",\n      \"provider-id\": \"urn:ivcap:provider:0f0e3f57-80f7-4899-9b69-459af2efd789\",\n      \"provider-ref\": \"service_foo_patch_1\",\n      \"references\": [\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Possimus et id harum iste dolores esse.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"image\": \"alpine\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            }\n         },\n         \"opts\": \"Quia minus.\",\n         \"type\": \"basic\"\n      }\n   }'")
		}
...
func BuildUpdatePayload(serviceUpdateBody string, serviceUpdateID string, serviceUpdateForceCreate string, serviceUpdateJWT string) (*service.UpdatePayload, error) {
	...
	var body UpdateRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"account-id\": \"urn:ivcap:account:0f0e3f57-80f7-4899-9b69-459af2efd789\",\n      \"banner\": \"http://aufderhar.com/florida_streich\",\n      \"description\": \"This service ...\",\n      \"metadata\": [\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         },\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         },\n         {\n            \"name\": \"Magni voluptatem quae nemo numquam dolorem eum.\",\n            \"value\": \"Repellat omnis perspiciatis quia nobis.\"\n         }\n      ],\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy-id\": \"Corrupti placeat iusto illo voluptate.\",\n      \"provider-id\": \"urn:ivcap:provider:0f0e3f57-80f7-4899-9b69-459af2efd789\",\n      \"provider-ref\": \"service_foo_patch_1\",\n      \"references\": [\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         },\n         {\n            \"title\": \"Ipsum autem possimus.\",\n            \"uri\": \"http://hudsoncruickshank.org/crawford.kilback\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Possimus et id harum iste dolores esse.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"image\": \"alpine\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            }\n         },\n         \"opts\": \"Quia minus.\",\n         \"type\": \"basic\"\n      }\n   }'")
		}
		if body.Workflow == nil {
			err = goa.MergeErrors(err, goa.MissingFieldError("workflow", "body"))
		}
