...
func BuildCreateServicePayload(serviceCreateServiceBody string, serviceCreateServiceJWT string) (*service.CreateServicePayload, error) {
	...
	var body CreateServiceRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"banner\": \"http://block.name/makenna_wilderman\",\n      \"description\": \"This service ...\",\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy\": \"urn:ivcap:policy:123e4567-e89b-12d3-a456-426614174000\",\n      \"references\": [\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         },\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Voluptas doloribus optio.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"gpu-number\": 2,\n            \"gpu-type\": \"nvidia-tesla-t4\",\n            \"image\": \"alpine\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            },\n            \"volume-mounts\": [\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               }\n            ],\n            \"volumes\": [\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               }\n            ]\n         },\n         \"opts\": \"Incidunt nihil molestias ut.\",\n         \"type\": \"basic\"\n      }\n   }'")
		}
...
func BuildUpdatePayload(serviceUpdateBody string, serviceUpdateID string, serviceUpdateForceCreate string, serviceUpdateJWT string) (*service.UpdatePayload, error) {
	...
	var body UpdateRequestBody
	{
		...
		if err != nil {
			return nil, fmt.Errorf("invalid JSON for body, \nerror: %s, \nexample of valid JSON:\n%s", err, "'{\n      \"banner\": \"http://johnstonmckenzie.info/issac\",\n      \"description\": \"This service ...\",\n      \"name\": \"Fire risk for Lot2\",\n      \"parameters\": [\n         {\n            \"description\": \"The name of the region as according to ...\",\n            \"label\": \"Region Name\",\n            \"name\": \"region\",\n            \"type\": \"string\"\n         },\n         {\n            \"label\": \"Rainfall/month threshold\",\n            \"name\": \"threshold\",\n            \"type\": \"float\",\n            \"unit\": \"m\"\n         }\n      ],\n      \"policy\": \"urn:ivcap:policy:123e4567-e89b-12d3-a456-426614174000\",\n      \"references\": [\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         },\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         },\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         },\n         {\n            \"title\": \"Quos ab et sed aperiam a.\",\n            \"uri\": \"http://dietrich.org/jeremie\"\n         }\n      ],\n      \"tags\": [\n         \"tag1\",\n         \"tag2\"\n      ],\n      \"workflow\": {\n         \"argo\": \"Voluptas doloribus optio.\",\n         \"basic\": {\n            \"command\": [\n               \"/bin/sh\",\n               \"-c\",\n               \"echo $PATH\"\n            ],\n            \"cpu\": {\n               \"limit\": \"100m\",\n               \"request\": \"10m\"\n            },\n            \"ephemeral-storage\": {\n               \"limit\": \"4Gi\",\n               \"request\": \"2Gi\"\n            },\n            \"gpu-number\": 2,\n            \"gpu-type\": \"nvidia-tesla-t4\",\n            \"image\": \"alpine\",\n            \"memory\": {\n               \"limit\": \"100Mi\",\n               \"request\": \"10Mi\"\n            },\n            \"volume-mounts\": [\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               },\n               {\n                  \"mount-path\": \"Nemo occaecati amet et consectetur.\",\n                  \"name\": \"Nisi dolorum corporis eum et voluptas vitae.\",\n                  \"read-only\": true\n               }\n            ],\n            \"volumes\": [\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               },\n               {\n                  \"name\": \"Velit qui omnis.\",\n                  \"volume-source\": \"{\\\"emptyDir\\\":{\\\"medium\\\" : \\\"Memory\\\"}}\"\n               }\n            ]\n         },\n         \"opts\": \"Incidunt nihil molestias ut.\",\n         \"type\": \"basic\"\n      }\n   }'")
		}
		if body.Workflow == nil {
			err = goa.MergeErrors(err, goa.MissingFieldError("workflow", "body"))
		}
